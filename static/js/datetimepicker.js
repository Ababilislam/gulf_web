...
var SpanBorderColor = "#EBEBEB";//span border color 
var SpanBgColor = "#EBEBEB";//span background color
var WeekChar=2;//number of character for week day. if 2 then Mo,Tu,We. if 3 then Mon,Tue,Wed.
var DateSeparator="-";//Date Separator, you can change it to "-" if you want.
var ShowLongMonth=true;//Show long month name in Calendar header. example: "January".
var ShowMonthYear=true;//Show Month and Year in Calendar header.
var MonthYearColor="#3F3F3F";//Font Color of Month and Year in Calendar header.
...
var WeekDayColor="#EBEBEB";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#CCCCCC";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#999999";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#999999"; //color when mouse move over.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' border=0 cellpadding=1 cellspacing=1 width='200px' valign='top' class='sample'>\n";
